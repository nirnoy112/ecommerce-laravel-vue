        ...
        <form class="form-horizontal" enctype="multipart/form-data" id="form"
            ...
            <div class="form_row">
                ...
                <div class="form_inline" style="display: flex">
                    <div class="custom_radio">
                        <input id="permanentYes" name="is_permanent" type="radio" class="custom-control-input"
                    ...
                    <div class="custom_radio">
                        <input id="permanentNo" name="is_permanent" type="radio" class="custom-control-input" value="0" {{ old('is_permanent') == '0' ? 'checked' : '' }}>
                        <label for="permanentNo" class="custom-control custom-radio" style="display: flex">
                            <span class="custom-control-indicator"></span>From&nbsp;&nbsp;<input type="text" id="valid_from" class="form-control{{ $errors->has('valid_from') ? ' is-invalid' : '' }}"
                                name="valid_from" value="{{ old('valid_from') }}">&nbsp;&nbsp;To&nbsp;&nbsp;<span class="custom-control-indicator"></span><input type="text" id="valid_to" class="form-control{{ $errors->has('valid_to') ? ' is-invalid' : '' }}"
