    ...
    <div class="tab_wrapper pa_0">
        <div class="ly_tab">
            <nav class="tabs tab_with_link">
                <div class="tab_three">
                    <ul>
                        ...
                        <li id="SizeChartTab" href="#SizeChart" class="tab_link" data-toggle="tab">Size Chart</li>
                        ...
                        <li id="ShippingInfoTab" href="#ShippingInfo" class="tab_link" data-toggle="tab">Shipping Info</li>
                    </ul>
                </div>
            </nav>
            <div class="tab_content_wrapper">
                ...
                <div id="sizeChart" class="tab_content size_chart_content">
                    <div class="fadein">
                ...
                <div id="ShippingInfo" class="tab_content">
                    <div class="fadein">                        
