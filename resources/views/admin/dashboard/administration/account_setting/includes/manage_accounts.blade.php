...
<div class="ly_accrodion">
    ...
    <div class="accordion_body default_accrodion open" id="addAccount" style="">
        ...
        <div class="form_row">
            ...
            <div class="form_inline">
                <div class="custom_checkbox mr_20">
                    <input type="checkbox" id="items" value="{{ Permissions::$ITEMS }}">
                    <label for="items">Items</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" id="ordersId" value="{{ Permissions::$ORDERS }}">
                    <label for="ordersId">Orders</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" id="customersId" value="{{ Permissions::$CUSTOMERS }}">
                    <label for="customersId">Customers</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" id="marketingTools" value="{{ Permissions::$MARKETING_TOOLS }}">
                    <label for="marketingTools">Marketing Tools</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" id="feedback" value="{{ Permissions::$FEEDBACK }}">
                    <label for="feedback">Feedback</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" id="statisticsId" value="{{ Permissions::$STATISTICS }}">
                    <label for="statisticsId">Statistics</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" id="messages" value="{{ Permissions::$MESSAGES }}">
                    <label for="messages">Messages</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" id="admin" value="{{ Permissions::$ADMIN }}">
                    <label for="admin">Admin</label>
                </div>

                <div class="custom_checkbox mr_20">
                    <input type="checkbox" id="payment" value="{{ Permissions::$PAYMENT }}">
        ...
        <div class="form_row">
            ...
            <div class="form_inline">
                <div class="custom_checkbox mr_20">
                    <input type="checkbox" id="refundAccess" value="{{ Permissions::$REFUND }}">
