                        ...
                        <div class="muyer_message width_full   ">
                            ...
                            <span class=" width_full    mb_5">
                                ...
                                <a class="ly_btn  btn_blue min_width_100p mt_15 btnReplay" role="button" data-message_id="{{ $message->id }}" data-message_user_id="{{ $message->user_id }}"
                                    data-message_subject="{{ $message->subject }}"  data-message_recipient="  @if(!empty($message['user']))  {{ $message['user']->first_name }} @endif &nbsp; @if(!empty($message->user->buyer)) ({{ $message->user->buyer->company_name}}) @endif "
                                    >Reply Message
                                </a>
                            </span>
                        </div>
                        ...
                        <div class="ly-wrap-fluid">
                            ...
                            <input type="hidden" name="user_id" id="message_user_id" value="">
                                <div class="ly-row">
                                    ...
                                    <div class="ly-9">
                                        <p id="sender">Sassy Apparel</p>
                                        <input type="hidden" name="sender" value="Sassy Apparel">
                                    </div>
                                </div>
                                <div class="ly-row">
