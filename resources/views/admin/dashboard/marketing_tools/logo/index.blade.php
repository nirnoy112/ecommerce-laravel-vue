                ...
                <div class="width_450p ">
                    <div class="form_row">
                        <div class="label_inline width_250p">
                            <label for="bigLogo">Site Big Logo:</label>
                        </div>
                    ...
                    <div class="form_row">
                        <div class="label_inline width_250p">
                            <label for="smallLogo">Site Small Logo:</label>
                        </div>
                        <div class="form_inline">
    ...
    <div class="row">
        <table class="table logo_preview">
            ...
            <tbody> 
                @if(!empty($logoBig))
                    <tr>
                        <td>@if($logoBig->name=='logo-big') Site Big Logo @endif</td>
                        <td><img src="{{ asset($logoBig->value) }}" alt="" class="img-fluid"></td>
                ...
                @if(!empty($logoSmalls))
                    <tr>
                        <td>@if($logoSmalls->name=='logo-small') Site Small Logo @endif</td>
                        <td><img src="{{ asset($logoSmalls->value) }}" alt="" class="img-fluid"></td>
