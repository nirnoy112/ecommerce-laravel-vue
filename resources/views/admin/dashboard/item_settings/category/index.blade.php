                        ...
                        @foreach($categories as $category)
                            <li class="dd-item" data-id="{{ $category['id'] }}">
                                ...
                                <div class="editdelete">
                                    <span>
                                        <a class="btnEdit color_blue" data-id="{{ $category['id'] }}" data-index="{{ $loop->index }}">Edit</a> |
                                    ...
                                    <ol class="dd-list">
                                        @foreach($category['subCategories'] as $sub)
                                            <li class="dd-item" data-id="{{ $sub['id'] }}">
                                                ...
                                                <div class="editdelete">
                                                    <span>
                                                        <a class="btnEdit color_blue" data-id="{{ $sub['id'] }}" data-index="{{ $loop->index }}" data-parent="{{ $loop->parent->index }}">Edit</a> |
                                                    ...
                                                    <ol class="dd-list">
                                                        @foreach($sub['subCategories'] as $sub2)
                                                            <li class="dd-item" data-id="{{ $sub2['id'] }}">
                                                                ...
                                                                <div class="editdelete">
                                                                    <span>
                                                                        <a class="btnEdit color_blue" data-id="{{ $sub2['id'] }}" data-index="{{ $loop->index }}" data-parent="{{ $loop->parent->parent->index }}" data-secondary-parent="{{ $loop->parent->index }}">Edit</a> |
