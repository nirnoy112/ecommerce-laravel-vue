                                                    ...
                                                    <div class="select">
                                                        <select class="form_global form-control-rounded form-control-sm" name="age_group">
                                                            <?php 
                                                                ...
                                                                if(!empty($buyer->ageGroup)){
                                                                    $buyerAgeGroup = $buyer->ageGroup->id;
                                                                }
                                                            ?>
                                                            <option value="">Select Age</option>
                                                            @foreach($ageGroups as $age)
                                                                <option value="{{ $age->id }}"
                                                                    {{ empty(old('age_group')) ? ($errors->has('age_group') ? '' : ($buyerAgeGroup == $age->id ? 'selected' : '')) :
                                                                    (old('age_group') == $age->id ? 'selected' : '') }}>{{ $age->lower_limit }} to {{ $age->upper_limit }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form_inline">
                                                    <div class="select">
                                                        <select class="form_global form-control-rounded form-control-sm" name="skin_type">
                                                            <?php 
                                                                $buyerSkinType = '';
                                                                if(!empty($buyer->skinType)){
                                                                    $buyerSkinType = $buyer->skinType->id;
                                                                }
                                                            ?>
                                                            <option value="">Select Skin Type</option>
                                                            @foreach($skinTypes as $skin)
                                                                <option value="{{ $skin->id }}" 
                                                                    {{ empty(old('skin_type')) ? ($errors->has('skin_type') ? '' : ($buyerSkinType == $skin->id ? 'selected' : '')) :
                                                                    (old('skin_type') == $skin->id ? 'selected' : '') }}>{{ $skin->type }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="ly-row">
                                        ...
                                        <div class="ly-5 pl_0">   
                                            <div class="form_row {{ $errors->has('phone') ? ' has-danger' : '' }}">
                                                ...
                                                <div class="form_inline">
                                                    <input type="text" class="form_global" id="phone" name="phone" value="{{ empty(old('phone')) ? ($errors->has('phone') ? '' : $buyer->shipping_phone) : old('phone') }}" placeholder="Phone">
                                                    @if ($errors->has('phone'))
                                    ...
                                    <div class="ly-row">
                                        ...
                                        <div class="ly-5 pl_0">   
                                            <div class="form_row {{ $errors->has('billingPhone') ? ' has-danger' : '' }}">
                                                ...
                                                <div class="form_inline">
                                                    <input type="text" class="form_global" id="billingPhone" name="billingPhone" value="{{ empty(old('billingPhone')) ? ($errors->has('billingPhone') ? '' : $buyer->billing_phone) : old('billingPhone') }}" placeholder="Phone">
