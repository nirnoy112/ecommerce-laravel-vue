    ...
    <div class="ly-wrap-fluid">
        <div class="ly-row">
            ...
            <div class="ly-6 pl_0 pr_60">
                ...
                <form method="get" class="form_inline" id="cuatomer_form" role="form" style="display: contents">
                    <div class="form_row">
                ...
                <table class="table" id="customer_off">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-check custom_checkbox">
                                    <input class="form-check-input mailing_list" type="checkbox" id="checkbox-mailing-list-{{ $buyer->id }}" value="1" data-id="{{ $buyer->id }}" data-user_id="{{ $buyer->user_id }}" data-billing_phone="{{ $buyer->billing_phone }}" {{ $buyer->receive_offers == 1 ? 'checked' : '' }}>
    ...
    <script>
        ...
        $(function () {
            ...
            $(".filter_customer").click(function(){  
                ...
                $("#cuatomer_form").submit(); // Submit the form
            });
