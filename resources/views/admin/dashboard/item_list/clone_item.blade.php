                    ...
                    <div class="accordion_body default_accrodion open" id="Video">
                        <div class="create_images_area">
                            ...
                            <div class="ly-row">
                                ...
                                <div class="ly-3 item-video-wrapper">
                                    @if ($item->video)
                        ...
                        <tbody id="itemInv">
                            @if(empty($errors->has('colors') || $errors->has('sizes')))
                                ...
                                @foreach($inventorydata as $inv)
                                    <tr @if($item->specification == 1 || $item->specification == 2 || $specification == 1 || $specification == 2) class="inv_{{$inv->color_id}}" @endif>
                                ...
                                @else
                                    @if (sizeof($item->images) > 0)
                                        @foreach($item->images as $img)
                                            <li class="img-item">
                                                <div class="image-item">
                                                    <img class="img-thumbnail img" style="margin-bottom: 10px" src="{{ asset($img->image_path) }}">
                                                    <br>
                                                        <select class="form_global image-color" name="imageColor[]">
                                                            <option value="">Color [Default]</option>
                                                        </select>
