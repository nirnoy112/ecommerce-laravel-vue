                    ...
                    <tr>
                        <td>
                            @if (sizeof($items[0]->item->images) > 0)
                                <img src="{{ public_path($items[0]->item->images[0]->thumbs_image_path) }}" alt="Product" style="height: 70px">
                            @else
            ...
            <table style="font-size:12px;margin-left: 390px">
                ...
                @if($order->dollar_point_discount)
                    <tr>
                        ...
                        <td style="width: 50px">${{ sprintf('%0.2f', $order->dollar_point_discount) }}</td>
                    </tr>
                @endif
