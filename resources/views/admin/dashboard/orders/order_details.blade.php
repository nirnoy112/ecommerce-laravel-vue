                    ...
                    <div class="ly-4">
                        ...
                        <ul class="order_details_cardinfo_ul mb_15">
                            ...
                            @if(@$order->authorize_info['status'] == 'Success')
                                <li class="mr_15"><span class="btn-primary">Captured</span></li>
                            @else
                                <li class="mr_15"><button type="button" class="ly_btn btn_blue" id="authorize_capture">Authorize and Capture</button></li>
                            @endif
                        ...
                        <table class="table table_bordered order_details_item_table">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="1" class=" text_right">Unit Price</th>
                                    <th colspan="1" class=" text_right">Amount</th>
                                    ...
                                    <tr>
                                        <td colspan="1">
                                            @if (sizeof($items[0]->item->images) > 0)
                                                <img class="width_50p" src="{{ asset($items[0]->item->images[0]->thumbs_image_path) }}" alt="Product">
                                            @else
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    @foreach($items as $item)
                                                        <tr class="grey_bg">
                                                            <td class="text_center" colspan="1">{{ $item->color }}</td>
                                                            <td class="size_ul">
                                                                <ul style="margin-left: 105px;">
                                                                    <li>
                                                                        <span> @if(!empty($item->itemsize)) {{ $item->itemsize->item_size }} @endif</span>
                                                                    </li>
                                                                </ul>
                                                            </td>
                                                            ...
                                                            <td colspan="1" class="text_right width_60p">
                        ...
                        <table class="table table_bordered">
                            <tbody>
                                ...
                                @if($order->authorizeHistory)
                                    @foreach($order->authorizeHistory as $k=>$thvalue)
                                        <tr>
                                            <td>
                                                <div class="panel-heading">
                                                    <h4 class="panel-title">
                                                        <a data-toggle="collapse" href="#collapse{{$thvalue->id}}">More Details</a>
                                                    </h4>
                                                </div>
                    ...
                    <div class="ly-4">
                        ...
                        <table class="table table_bordered border order_details_summation">
                            <tbody>
                                ...
                                {{-- <tr>
                                    <td><strong>Store Credit(@if(!empty($storecredit)) ${{$storecredit->amount}} @else 0 @endif)</strong></td>
                                    <td>
                        ...
                        <div class="ly-12">
                            <div class="form_row">
                                ...
                                <div class="form_inline">
                                    <p id="sender">Miss & More</p>
                                    <input type="hidden" name="sender" value="Miss & More">
                                </div>
                            </div>
                            <div class="form_row">
                                <div class="label_inline fw_500 width_150p">
                            ...
                            <div class="item_list">
                                <div class="item_list_text">
                                    @if (sizeof($item->images) > 0)
                                        <img src="{{ asset($item->images[0]->compressed_image_path) }}" alt="{{ $item->style_no }}">
                                    @else
...
@section('additionalJS')
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '#authorize_capture', function (e) {
