...
<header class="header_area">
    <ul>
        ...
        <li class="header_msg"><a href="{{ route('all_message') }}"><span class="red_bg">{{ $unread_messages }}</span> MESSAGES&nbsp;&nbsp;&nbsp;&nbsp;</a>
        </li>
        <li class="header_accordion"> <span><i class="fas fa-cog"></i> ADMINISTRATION&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
            <ul class="header_acc_content">
                ...
                <ul class="sub_accordion default_accrodion" id="VendorInfo">
                    ...
                    <li><a href="{{ route('admin_admin_information') }}#ShippingInfo"> Shipping Info</a></li>
                </ul>
                ...
                <ul class="sub_accordion default_accrodion" id="Pages">
                    ...
                    <li><a href="{{ route('admin_page_view', ['id' => PageEnumeration::$RETURN_POLICY]) }}">Return Policy</a></li>
