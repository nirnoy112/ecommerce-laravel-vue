                ...
                <div class="col-md-3 col-lg-2 padding_10px">
                    <div class="product_left above_mobile">
                        <div class="browse_by">
                            ...
                            <h3 class="product_left_subtitle">Categories</h3>
                            <ul>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="main_product_head_left">
                                    <h2>Search <span>{{ $totalItems }} results</span> </h2>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="main_product_head_right ">
                                    ...
                                    <div class="product_pagination pagination-data">
...
<script>
        ...
        $(function () {
            ...
            $('.nav-item').hover(function() {
                $(this).find('.dropdown_menu').addClass('open_dropdown');
            });
            $('.nav-item').mouseleave(function() {
                $(this).find('.dropdown_menu').removeClass('open_dropdown');
            });
