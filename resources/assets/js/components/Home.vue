...
export default {
    ...
    computed:{   
        metaData() {
            return {
                pageTitle: 'Miss & More - $1.50 Store',
                charset: 'utf-8',
                viewport: 'width=device-width, initial-scale=1, shrink-to-fit=no',
                title: 'Miss & More $1.50 retail cosmetics web store',
                description: 'Miss & More is a retail cosmetics web store where you can purchase any cosmetics product you need within $1.50 expense.'
            }
        },
        MainContent(){   
