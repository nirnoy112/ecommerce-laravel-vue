<template>
    ...
    <header class="header_area checkout_header">
        <div class="main_header cm_header fixed-top">
            <div class="c_l_logo">
                <router-link :to="'/'"><img :src="headerContents && headerContents.logo ? headerContents.logo : '/themes/front/media/images/logo-hasan.png'" alt="Site logo" class="img-fluid"></router-link>
