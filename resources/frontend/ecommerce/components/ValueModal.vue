<template>
    <div class="modal open_modal" data-modal="ls">
        ...
        <div class="modal_wrapper">
            ...
            <div class="size_modal_wrap">
                <div class="size_modal_left">
                    <img :src="allValues[currentIndex].image_path ? allValues[currentIndex].image_path  : '/images/no-image.png'" :alt="'Hologram Product Value' + allValues[currentIndex].name" class="img-fluid">
                </div>
