            ...
            <div class="cart_content">
                                    ...
                                    <tr v-for="(cartItem, cartItemKey) in cartInputs" :key="'cartItem_' + cartItemKey">
                                        <td>
                                            <div class="cart_product">
                                                <router-link :to="{ name: 'single-product', params: { parent: cartItem.slug }}">
                    ...
                    <div class="promo_code_wrap">
                        <div class="promo_code">
                            ...
                            <div class="promo_code_details" id="promo_code" v-if="customer">
                                ...
                                <!-- <div class="promo_code_details_inner" v-if="customer">
                                    <input type="text" class="form-control" placeholder="Enter Promotional code / Gift voucher" v-model="newCoupon">
                                    <button class="btn_common" @click.prevent="applyCoupon" :disabled="couponLoader" ref="couponButton">apply</button>
                                    <div class="err_msg" v-for="(formError, errorIndex) in defaultFormErrors['coupon']" :key="'error_name_'+errorIndex"><span v-if="errorIndex == 0">{{formError}}</span></div>
                                </div>
                                <div class="promo_code_details_inner" v-else>
                ...
                <div class="cart_right">
                    ...
                    <div class="proceed_btn text-center">
                        ...
                        <!-- <router-link :to="{ name: 'customer-login'}" class="btn btn_transparent"  v-if="!customer">
                            Login To Checkout
                        </router-link>
                        <router-link :to="{ name: 'checkout' }" class="btn btn_common" v-else-if="cartItems && cartItems.length > 0">
                            <i class="lni-lock"></i> <span class="ml_5">Pay Securely Now</span>
                        </router-link>
                        <router-link :to="{ name: 'home'}" class="btn btn_transparent" v-else>
                            <i class="fas fa-shopping-cart"></i> <span class="ml_5">Continue Shopping</span> 
            ...
            <div class="shipping_return">
                <div class="s_r_inner">
                    ...
                    <p>Is free, or just a little fee. View our full shipping rates and information 
                        <router-link :to="'/shipping-returns'">
                            here.
                        </router-link>
                    </p>
                </div>
                <div class="s_r_inner">
                    <h2>RETURNS</h2>
                    <p>If you are unhappy with your item for some reason (which we're sure you won't be), you can return or exchange it. View our full returns and exchanges policy 
                        <router-link :to="'/shipping-returns'">
                            here.
                        </router-link>
