            ...
            <div class="card my_acc_order">
                ...
                <div class="card-body" style="position:relative; min-height:150px;">
                    ...
                    <div class="row" v-if="orderSingle">
                        <div class="col-md-5">
                            <img :src="headerContents && headerContents.logo ? headerContents.logo : '/themes/front/media/images/logo-hasan.png'" alt="Site logo">
                            <!-- <p>
                                Arizona,
                                United States - 1235
                            </p> -->
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody v-if="orderSingle && orderSingle.items">
                                <tr v-for="(orderItem, itemIndex) in orderSingle.items" :key="'orderItem_' + itemIndex">
                                    <td rowspan="">
                                        <img :src="'/' + (orderItem.item.images && orderItem.item.images.length > 0 ? orderItem.item.images[0].thumbs_image_path : defaultImage.value)" :alt="'Hologram Product ' + orderItem.item.style_no" style="height:100px">
                                    </td>
                                    <td class="text-center"> {{orderItem.style_no}}</td>
                                    <td class="text-center"> {{orderItem.qty}}</td>
                                    <td class="text-center"> ${{orderItem.per_unit_price}}</td>
                                    <td class="text-right"> ${{orderItem.per_unit_price * orderItem.per_unit_price}}</td>
                                </tr>
                        ...
                        <div class="col-md-3">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <th>Sub Total</th>
                                        <td class="text-right">${{orderSingle.subtotal}}</td>
                                    </tr>
                                    <tr>
                                        <th>Discount</th>
                                        <td class="text-right">${{orderSingle.discount}}</td>
                                    </tr>
                                    <tr v-if="orderSingle.dollar_point_discount > 0">
                                        <th>Point Discount</th>
                                        <td class="text-right">${{orderSingle.dollar_point_discount}}</td>
                                    </tr>
                                    <tr>
                                        <th>Shipping Cost</th>
                                        <td class="text-right">${{orderSingle.shipping_cost}}</td>
                                    </tr>
                                    <tr>
                                        <th>Total</th>
                                        <td class="text-right"><b>${{orderSingle.total}}</b></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
