                ...
                <div class="col-md-12">
                    <div class="login_inner">
                        ...
                        <div class="header_account_inner">
                            ...
                            <button class="btn_common" @click.prevent="buyerNewPassword" :disabled="newPasswordLoader" ref="newPasswordButton">Reset Password</button>
...
<script> 
    ...
    export default {
        ...
        mounted() {
            ...
            this.newPasswordInput.email = decodeURIComponent(this.$route.query.email)
        },
        watch: {
        ...
        methods: {
            buyerNewPassword() {
                ...
                this.$store.dispatch('customerStore/sendNewPassword', formData);
            },
            validateNewPassword() {
                let isValid = true;
