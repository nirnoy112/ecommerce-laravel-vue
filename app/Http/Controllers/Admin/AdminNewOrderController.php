...
class AdminNewOrderController extends Controller
{
    public function itemListAll(Request $request) {
        ...
        return view('admin.dashboard.admin_order.index', compact('userData','TotalactiveItems','activeItems', 'defaultCategories', 'vendorCategories' , 'customers' , 'current_customer' , 'cart_items' , 'selected_items_list', 'appends'))
